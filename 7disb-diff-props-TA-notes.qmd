...
Exercise 6.22 and 6.24 (part a) on page 254 of [the book](https://www.openintro.org/go/?id=os4_for_screen_readers&referrer=/book/os/index.php).

_6.22 Sleep Deprivation, CA vs OR, Part 1_

According to a report on sleep deprivation by the Centers for Disease Control and PRevention, the proportion of California residents who reported insufficient rest or sleep during each of the preceding 30 days is 8.0$\%$, while this proportion is 8.8$\%$ for Oregon residents. These data are based on simple random samples of 11,545 California and 4,691 Oregon residents. Calculate a 95$\%$ confidence interval for the difference between the proportions of Californians and Oregonians who are sleep deprived and interpret it in context of the data.

_6.22 Solution_

We first check conditions:

Independence is met because the residents of both California and Oregon come from simple random samples.

There are 924 Californians that reported insufficient rest and 10,621 that did not. There are 413 Oregonians that reported insufficient rest and 4,278 that did not. These values are all greater than 10 so this condition is met.

__Point estimate:__

The point estimate is $0.08 - 0.088 = -0.008$.

__Critical Value:__

For a 95\% CI, our critical value is $1.96$.

__Standard Error:__

The standard error is $\sqrt{\frac{(0.08)(0.92)}{11545} + \frac{(0.088)(0.0912)}{4691}} = 0.004846$

__Confidence Interval:__

Putting this all together, our 95\% confidence interval is $-0.008 \pm 1.96*0.004846$ or $(-0.017,0.001)$

_6.24 Sleep Deprivation, CA vs OR, Part 2_

Exercise 6.22 provides data on sleep deprivation rates of Californians and Oregonians. The proportion of California residents who reported insufficient rest or sleep during each of the preceding 30 days is 8.0$\%$, white this proportion is 8.8$\%$ for Oregon residents. These data are based on simple random samples of 11,545 California and 4,691 Oregon residents.
...
Let $\pi_{CA}$ be the proportion of Californians with sleep deprivation and $\pi_{OR}$ be the proportion of Oregonians with sleep deprivation.
...
__Calculate Pooled Proportion:__

$p_{pooled} = \frac{924+413}{11545+4691} = \frac{1337}{16236} = 0.082$

__Calculate Standard Error:__

$SE = \sqrt{\frac{(0.082)(0.918)}{11545} + \frac{(0.082)(0.918)}{4691}} = 0.00475$

__Calculate p-value:__

```{r}
2 * pnorm(-0.008 / 0.00475)
```
