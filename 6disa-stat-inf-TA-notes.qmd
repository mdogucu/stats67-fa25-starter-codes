...
> "Does a new teaching method improve student test scores compared to traditional methods?"
...
Let's say mu1 is the average test score of students when using the new method.
mu2 is the average test score of students when using the old method.
...
In order to determine whether we will reject or fail to reject our null hypothesis, we can look at our p-value which helps us determine the significance of our results. 
